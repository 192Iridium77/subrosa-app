...
export default function App() {
  ...
  return (
    <div className="relative h-screen">
      ...
      {/* <MenuLeft /> */}
      <div className="p-20 bg-gray-200 h-full">
        <div className="flex h-full bg-white justify-between items-center divide-x-4 divide-gray-200">
          <div
